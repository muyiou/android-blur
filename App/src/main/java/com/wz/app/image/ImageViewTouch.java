...
import android.view.ViewConfiguration;import java.lang.Math;import java.lang.Override;
...
public class ImageViewTouch extends ImageViewTouchBase {
	...
	protected void onZoomAnimationCompleted( float scale ) {
		...
		if( ImageViewTouchBase.LOG_ENABLED ) {
			Log.d( ImageViewTouchBase.LOG_TAG, "onZoomAnimationCompleted. scale: " + scale + ", minZoom: " + getMinScale() );
		}
	...
	public class GestureListener extends GestureDetector.SimpleOnGestureListener {
		...
		public boolean onDoubleTap( MotionEvent e ) {
			Log.i( ImageViewTouchBase.LOG_TAG, "onDoubleTap. double tap enabled? " + mDoubleTapEnabled );
